...
function ngakjadi() {
  location.replace("http://localhost/webproB1/client/index.php?p=mhs")
}
</script>
<script src="http://localhost/webproB1/client/MHS/pagemhcaridata.js"></script>
<script src="http://localhost/webproB1/client/MHS/pagemhsupdatedata.js"></script>